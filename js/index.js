// My Public API - 3a536c241086fd5a7f224f6f9827822f

// hash -  f758b2160da770e6b0ec0bdfcf23517e
...
document.getElementById("search-form").addEventListener('keyup' , function(){
 ...
 //  If search query matches the results then it will execute next function/command.
     if(!searchQuery){
         ...
         return "https://gateway.marvel.com/v1/public/comics?ts=1&apikey=3a536c241086fd5a7f224f6f9827822f&hash=f758b2160da770e6b0ec0bdfcf23517e"
     }else{
         return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${searchQuery}&apikey=3a536c241086fd5a7f224f6f9827822f&hash=f758b2160da770e6b0ec0bdfcf23517e&ts=1`
     }
 }
